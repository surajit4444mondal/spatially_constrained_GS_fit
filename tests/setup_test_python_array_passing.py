...
ext_modules=[Extension('change_numpy_arrays_inplace_in_cython',sources=["change_numpy_arrays_inplace_in_cython.pyx"],libraries=["m"],include_dirs=[numpy.get_include()])]
